 ...
 *
 * Detection:  Sable.HELPER.getContaining(level, blockPos) → non-null means on sublevel.
 *
 * Data (from CCSableUtils.java and SubLevelAPI.java):
...
public class SableCompat {
    ...
    /**
     * Returns the keyboard block's true world-space position by transforming its ship-local
     * block centre through the sublevel's logical pose. Falls back to quaternion math if the
     * Vec3 overload of transformPosition is unavailable, or to the ship centre if that fails.
     */
